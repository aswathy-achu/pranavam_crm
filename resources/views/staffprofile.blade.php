...
<?php 
    $images = asset('storage/app/staff_photo/' . $admin->staff_profile_image);
                ...
                <div class="container">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="d-flex flex-column align-items-center text-center">
                            @if(isset($images) && !empty($admin->date_of_joining))
                                <img src="{{ $images }}" class="rounded-circle" width="150" height="150">
                                <input type="hidden" name="admin_profile_image" value="{{ $admin->staff_profile_image }}">
                            @else
                            ...
                            <p>EMP ID: {{ $admin->user_id }}</p>
                            <p>Job Role: {{ $admin->jobrole }}</p>
                            @if(Auth::user()->type == 'S')
                                <a href="{{ route('editstaffprofile') }}" class="btn btn-primary">Edit Profile</a> 
                            @endif 
                        </div>
                    </div>
                </div>
                <div class="col-lg-8">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <tr>
                                ...
                                <td width="2%">:</td>
                                <td>{{ date('Y-m-d', $admin->date_of_joining) }}</td>
                            </tr>
                            </table>
                        </div>
                        </div>
